...
// Update the placementStats to use standardized department names
const placementStats = departments.map(dept => ({
  department: dept.label,
  placed: Math.floor(Math.random() * 50), // Example data
  total: Math.floor(Math.random() * 100), // Example data
  percentage: Math.floor(Math.random() * 100), // Example data
}));
